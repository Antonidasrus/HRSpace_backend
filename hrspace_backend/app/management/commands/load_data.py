...
from app.models import (Specialization, Towns, Experience, Education,
                        Language, LanguageLevel, Registration, Occupation,
                        Skill, Schedule, Expectations, Payments)
...
MODELS_FIELD_NAME = (
    Specialization, Towns, Experience, Education, Language, LanguageLevel,
    Registration, Occupation, Skill, Schedule, Expectations, Payments
)
...
def application_app_models_fill():
    ...
    for index in range(len(MODELS_FIELD_NAME)):
        ...
        for row in tqdm(DictReader(io.open(
            f'static/data/{name_model}.csv', mode='r', encoding='utf-8'
        )), desc='Processing'):
