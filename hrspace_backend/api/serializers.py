...
class ApplicationSerializer(ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        experience_name = validated_data.pop(
            'experience', {}).get('name')
        education_name = validated_data.pop(
            'education', {}).get('name')
        payments_name = validated_data.pop(
            'payments', {}).get('name')
        towns_name = validated_data.pop(
            'towns', {}).get('name')
        ...
        application.skills.set(Skill.objects.filter(
            name__in=skills_data),)
        application.registration.set(Registration.objects.filter(
            name__in=registration_data))
        ...
        application.expectations.set(Expectations.objects.filter(
            name__in=expectations_data))
